...
namespace MoreMountains.CorgiEngine
{
	...
	public class Weapon : MMMonoBehaviour
    {
        ...
        public virtual void Initialization()
		{
            ...
            if ((_characterHorizontalMovement != null) && (this.enabled))
            {
        ...
        protected virtual void TurnWeaponOn()
        {
            ...
            if (PreventHorizontalGroundMovementWhileInUse && (_characterHorizontalMovement != null) && (_controller != null) && (_controller.State.IsGrounded))
            {
	            _characterHorizontalMovement.SetHorizontalMove(0f);
	            _characterHorizontalMovement.MovementForbidden = true;
            }
            if (PreventHorizontalAirMovementWhileInUse && (_characterHorizontalMovement != null) && (_controller != null) && (!_controller.State.IsGrounded))
            {
	            _characterHorizontalMovement.SetHorizontalMove(0f);
	            _characterHorizontalMovement.MovementForbidden = true;
            }
        ...
        public virtual void TurnWeaponOff()
        {
            ...
            if (PreventHorizontalGroundMovementWhileInUse && (_characterHorizontalMovement != null))
            {
	            _characterHorizontalMovement.MovementForbidden = false;
            }
            if (PreventHorizontalAirMovementWhileInUse && (_characterHorizontalMovement != null))
            {
	            _characterHorizontalMovement.MovementForbidden = false;
            }
            if (SetForceWhileInUse)
