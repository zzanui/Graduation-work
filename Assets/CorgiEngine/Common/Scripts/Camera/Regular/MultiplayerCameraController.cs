...
namespace MoreMountains.CorgiEngine 
{
	...
	public class MultiplayerCameraController : MonoBehaviour 
	{
		...
		[Range(0,2)]
		[Tooltip("Defines how fast does the camera change position. Small value : faster camera")]
		...
		/// Minimal zoom size
		[Tooltip("Minimal zoom size")]
		public float OrthoMinSize = 6.5f;
		/// Space around the screen added after the most distant car
		[Tooltip("Space around the screen added after the most distant car")]
		...
		[Tooltip("the minimum coordinates to which the camera will be constrained")]
		public Vector3 MinPosition;
		/// the maximum coordinates to which the camera will be constrained
		[Tooltip("the maximum coordinates to which the camera will be constrained")]
